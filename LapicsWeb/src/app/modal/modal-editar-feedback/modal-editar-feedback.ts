...
@Component({
  selector: 'ngbd-modal-editar-feedback',
  templateUrl: './modal-editar-feedback.html'
})
export class NgbdModalEditarFeedback {
  ...
  constructor(private modalService: NgbModal,
    ...
    private feedbackService: FeedbackService) {
      ...
      this.feedback = this.feedbackService.getFeedbackSelecionado()           
